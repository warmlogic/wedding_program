...
\item [] Expression of Intent \& Vows
\item [] Ring Ceremony
\item [] Pronouncement
\item [] Recessional
\end{itemize}
...
\begin{itemize}[topsep=-5pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
\item [] Fabian Ca\~{n}as, Wade Mollison, Anthony Helmstetter, 
...
\begin{itemize}[topsep=-5pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
\item [] Fabian Ca\~{n}as, playing a Mountain Goats medley of his own arrangement
\end{itemize}
