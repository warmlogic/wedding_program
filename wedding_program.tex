...
\ThisULCornerWallPaper{.4}{hops_upper_left_border.pdf}
\ThisLRCornerWallPaper{.4}{hops_lower_right_border.pdf}
...
\includegraphics[width=.55\textwidth]{/Users/matt/src/iphone-sms-backup/data/texts_count.png} & \multicolumn{3}{c}{\raisebox{2.8in}{Most used emojis!}} \\
\includegraphics[width=.55\textwidth]{/Users/matt/src/iphone-sms-backup/data/texts_love_normalized.png} &
\multirow{2}{*}[5.8in]{\includegraphics[width=.1\textwidth]{/Users/matt/src/iphone-sms-backup/data/emoji_both.png}} &
\multirow{2}{*}[5.8in]{\includegraphics[width=.0667\textwidth]{/Users/matt/src/iphone-sms-backup/data/emoji_alice.png}} &
\multirow{2}{*}[5.8in]{\includegraphics[width=.065\textwidth]{/Users/matt/src/iphone-sms-backup/data/emoji_matt.png}} \\
\end{tabular}
